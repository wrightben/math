...
var	players = 6,
	...
	hands = evaluateHands( 
		getCardsAsPlayers(players, getCards([players, [
			getCardsFromString( "4c 2c" ),
			getCardsFromString( "5h ad" ),
			getCardsFromString( "qd kc" ), // Expected #1
			getCardsFromString( "6d 9c" ),
			getCardsFromString( "ac 2s" ),
			getCardsFromString( "8c qc" ) // Expected #2
		]], shared))
	);
