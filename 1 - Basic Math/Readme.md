...
-  **Cubed Root Example.numbers** - <sup>3</sup>√180, another form for log<sub>x</sub> 180 = 3, is just repeated division, where the correct answer is a row ending in 1. Further evidence that *language* has subordinated *learning*.
